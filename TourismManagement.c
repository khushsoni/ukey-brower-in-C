...
int main()
{
	...
	printf("\n");
	printf("%c%c%c%c%c%c%c Home %c%c%c%c%c%c www.ukeytravels.in         %c%c%c%c x %c%c",a,a,a,b,a,c,a,a,a,a,a,a,a,a,a,a,a,a,a);
	for(i=1;i<=32;i++)
	{ 
		printf("%c",a);
...
{
	system("CLS");
    printf("\tPRICE LIST\n=============================\n1. AA - Maldives Tours - Rs 40000\n2. BB - Singapore Tours - Rs 60000\n3. CC - Dubai Tours - Rs 45000\n4. DD - Miami Vacation - Rs 38000\n"
           "5. EE - Hawaii - Rs 120000\n6. FF - Kerala Local Tours - Rs 10000\n7. GG - Ladakh Tours - Rs 30000\n8. HH - Goa Vacation - Rs 15000\n9. II - Manali Vacation - Rs 25000\n10. JJ - Super Budget USA  - Rs 250000\n");
}
...
void CancelTicket(user *h)
{
    ...
    if(strcmp(h->place,"AA")==0)
        flag++;
    else if(strcmp(h->place,"BB")==0)
        flag++;
    else if(strcmp(h->place,"CC")==0)
        flag++;
    else if(strcmp(h->place,"DD")==0)
        flag++;
    else if(strcmp(h->place,"EE")==0)
        flag++;
    else if(strcmp(h->place,"FF")==0)
        flag++;
    else if(strcmp(h->place,"GG")==0)
        flag++;
    else if(strcmp(h->place,"HH")==0)
        flag++;
    else if(strcmp(h->place,"II")==0)
        flag++;
    else if(strcmp(h->place,"JJ")==0)
        flag++;
    else
    {
